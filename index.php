...
require './tools/database/connexion_db.php';
?>
<!DOCTYPE html>
<html lang="en">
...
if (!($_GET['azerty'] ?? null)) {
  ...
  <div class=p-4> <?php $o = new PDO('mysql:host=127.0.0.1;dbname=recette', 'root', '');
    ...
    <div class=columns> <?php foreach ($p as $pr) {
        ...
        <div class=card>
          <div class=card-image>
            <div class="image is-4by3"><img src="/<?php echo $pr['picture']; ?>.jpeg"></div>
          </div>
	...
	?> <div class=pagination><a
        ...
        href="?ttt=<?php echo (($_GET['ttt'] ?? 0) ? $_GET['ttt'] + 3 : 1); ?>" class=pagination-next>Suivant</a></div>
  </div> <?php
} else {
